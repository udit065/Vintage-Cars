...
<div class="jumbotron">
 ...
 <u><h1 align="center">Ferrari 308 GTS</h1></u><br>
  <img src="\VINTAGE CAR WIKI PROJECT\images\cc10.JPG"><br><br><br>
<h1 align="center">Vehicle Detail</h1>
<div>
  <ul class="list-group list-group-flush w-75 container" id="Vdetail">
  <li class="list-group-item"><span class="pl-5">Listing ID:</span><span class="pl-5" style="margin-left: 50px;">CC-1344821</span></li>
  <li class="list-group-item bg-light"><span class="pl-5">Price:</span><span class="pl-5" style="margin-left: 93px;">$99,000 (OBO)</span></li>
  <li class="list-group-item"><span class="pl-5">Location:</span><span class="pl-5" style="margin-left: 63px;">Lebanon, Missouri</span></li>
  <li class="list-group-item bg-light"><span class="pl-5">Year:</span><span class="pl-5" style="margin-left: 97px;">1984</span></li>
  <li class="list-group-item"><span class="pl-5">Make:</span><span class="pl-5" style="margin-left: 90px;">Ferrari</span></li>
   <li class="list-group-item bg-light"><span class="pl-5">Model:</span><span class="pl-5" style="margin-left: 85px;">308 GTS</span></li>
      <li class="list-group-item"><span class="pl-5">Exterior Color:</span><span class="pl-5" style="margin-left: 20px;">Rossa Corsa (Red)</span></li>
     <li class="list-group-item bg-light"><span class="pl-5">Interior Color:</span><span class="pl-5" style="margin-left: 25px;">Black</span></li>
      <li class="list-group-item"><span class="pl-5">Transmission:</span><span class="pl-5" style="margin-left: 30px;">Manual</span></li>
      <li class="list-group-item bg-light"><span class="pl-5">Engine Size:</span><span class="pl-5" style="margin-left: 42px;">V-8</span></li>
       <li class="list-group-item"><span class="pl-5">Odometer:</span><span class="pl-5" style="margin-left: 55px;">36170</span></li>
        <li class="list-group-item bg-light"><span class="pl-5"></span>Stock Number:</span><span class="pl-5" style="margin-left: 20px;">3425</span></li>
         <li class="list-group-item "><span class="pl-5">VIN:</span><span class="pl-5" style="margin-left: 99px;">ZFFLA13B000049067</span></li>
         <li class="list-group-item bg-light"><span class="pl-5">Title Status:</span><span class="pl-5" style="margin-left: 45px;">Clear</span></li>
</ul>
...
<div>
  <div>
    <a href="\VINTAGE CAR WIKI PROJECT\homepage.php">
      <img src="\VINTAGE CAR WIKI PROJECT\images\logo1.png" alt="VintageCars.com" id="logo">
    </a>
  </div>
  <footer>
